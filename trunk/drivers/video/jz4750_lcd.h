...
#define FBIO_GET_BUFFER     0x46a8 /* get current framebuffer */
...
#elif defined(CONFIG_JZ4750L_TAURUS) /*  board taurus */
        #define SPEN            (32*2+19)       /* LCD_CS*/
        #define SPCK            (32*2+16)       /* LCD_SCL*/
        #define SPDA            (32*2+17)       /* LCD_SDA*/
        #define LCD_RET         (32*3+24)       /* LCD_DISP_N use for lcd reset*/
#else
