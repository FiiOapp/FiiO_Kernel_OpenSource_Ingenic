...
#define MAX_SSICDR_DIV			CPM_SSICDR_SSIDIV_MASK
#define MAX_SSIGR_CGV			255
#else
#define MAX_SSICDR_DIV			SSICDR_SSIDIV_MASK
#define MAX_SSIGR_CGV			255
#endif
...
#define GPIO_AS_SSI(n)			__gpio_as_ssi()
#define GPIO_AS_SSI_EX(n)		__gpio_as_ssi_x()
#elif defined(CONFIG_SOC_JZ4750L) /* jz4750l */
#define GPIO_AS_SSI(n)			__gpio_as_ssi()
#define GPIO_AS_SSI_EX(n)		__gpio_as_ssi_without_ce()
#else
...
#define CPM_SSI_START(n) 	__cpm_start_ssi(0)
#define CPM_SSI_STOP(n)		__cpm_stop_ssi(0)
...
#define SSI0_CE0_PIN		GPIO_PC(19)
...
static inline void start_transmit(struct jz47xx_spi *hw)
{
